      ...
      >
        ...
        <div className="glass-card p-10 bg-background/60 backdrop-blur-3xl border-border shadow-2xl relative">
           <div className="text-center mb-10">
              <h1 className="font-heading text-3xl text-foreground mb-3">Welcome Back</h1>
              <p className="font-body text-text-secondary">Sign in to your private wealth protocol</p>
           </div>
